...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleBookingCollision(BookingCollisionException ex, HttpServletRequest request) {
        log.warn("Booking time collision detected [traceId={}]: {}", getTraceId(), ex.getMessage());
        ErrorResponse errorResponse = ErrorResponse.builder()
    ...
    public ResponseEntity<ErrorResponse> handleFeignException(FeignException ex, HttpServletRequest request) {
        log.error("Downstream Feign client call failed [traceId={}]: status={}, message={}", getTraceId(), ex.status(), ex.getMessage());
        ...
        ErrorResponse errorResponse = ErrorResponse.builder()
                .status(status.value())
                .message("Downstream service error: " + errorMessage)
                .traceId(getTraceId())
                .path(request.getRequestURI())
                .timestamp(LocalDateTime.now().toString())
                .build();
